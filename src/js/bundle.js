...
function calc() {
    ...
    function calcTotal() {
        ...
        if (age > 150 || weight > 250 || height > 250) {
            result.textContent = 'Врешь...';
            return;
        }
        if (sex === 'female') {
...
function forms(formsSelector, modalTimerId) {
    ...
    function showThanksModal(message) {
        ...
        (0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimerId);  // <-- Передайте аргументы
        ...
        setTimeout(() => {
            ...
            (0,_modal__WEBPACK_IMPORTED_MODULE_0__.closeModal)('.modal');  // <-- Передайте аргументы
        }, 4000);
    }
}
